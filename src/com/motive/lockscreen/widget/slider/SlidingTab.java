...
package com.motive.lockscreen.widget.slider;
...
public class SlidingTab extends ViewGroup {
    ...
    public SlidingTab(Context context, AttributeSet attrs) {
        ...
        mOrientation = a.getInt(R.styleable.SlidingTab_android_orientation, HORIZONTAL);
        a.recycle();
        ...
        mRightSlider = new Slider(this,
                ...
                R.drawable.jog_tab_target_gray);
        mLeftSlider.setIcon(R.drawable.ic_jog_dial_unlock);
     ...
     * @param tabId the resource of the
     */
    public void setLeftTabIcon(int iconId) {
        mLeftSlider.setIcon(iconId);
        mLeftSlider.updateDrawableStates();
    }
     ...
     * @param tabId the resource of the
     */
    public void setRightTabResources(int iconId) {
        mRightSlider.setIcon(iconId);
        mRightSlider.updateDrawableStates();
    }
    /**
